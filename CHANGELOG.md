...
## [1.11.0](https://github.com/justinmerrell/podflow/compare/v1.10.0...v1.11.0) (2025-02-16)


### Features

* add installer of deps ([97699f9](https://github.com/justinmerrell/podflow/commit/97699f917744daac87a91f6c3ad81fe0cf44183b))
* add installer script ([b2a75a7](https://github.com/justinmerrell/podflow/commit/b2a75a7f5d16271d898e0d4457500e68fe380b8a))
* add user agent and fix project example ([ef38812](https://github.com/justinmerrell/podflow/commit/ef388126577c5983d73c9b67837d9a72df353ea1))
* add uv support ([0e9841a](https://github.com/justinmerrell/podflow/commit/0e9841ad23cc2ed43f61e816e9549c0185eb2dcb))
* added comments to toml ([d0f1bfa](https://github.com/justinmerrell/podflow/commit/d0f1bfa65ac8ac477f429b18b6d19467b3dc3a6a))
* added more starter examples ([57474e5](https://github.com/justinmerrell/podflow/commit/57474e592d23b1e1efcf07355081916f480b1574))
* added package manager selection ([ebfdb6b](https://github.com/justinmerrell/podflow/commit/ebfdb6b7362f3750fcd9059865cf510d78e32ec7))
* cache venvs in tar format ([a0fec98](https://github.com/justinmerrell/podflow/commit/a0fec9823d068d063e3f1f5ff77bc4c1815a7b7e))
* flag to print pod logs without prefix ([0f93a1a](https://github.com/justinmerrell/podflow/commit/0f93a1a70fcf7742c4e0351c5822c90d177c8014))
* fork from github ([9ad423f](https://github.com/justinmerrell/podflow/commit/9ad423f56b7041509033ffe6b04c2a4200080289))
* handle deleted network volume, dropdown for starter templates, template Dockerfile ([d042edb](https://github.com/justinmerrell/podflow/commit/d042edba17b47a565ea38b17f88bcfe90a98c47f))
* no longer release-please, just combine brew and existing build actions ([199b022](https://github.com/justinmerrell/podflow/commit/199b022dddb32abcc5beea2b6f5a09053435ef12))
* port change and base update for proxy ([69a38a4](https://github.com/justinmerrell/podflow/commit/69a38a49b52ce7cb6acd4e9dbe0b641f3d1453e6))
* port ssh cmd from python, refactored ssh key gen ([4c90f4b](https://github.com/justinmerrell/podflow/commit/4c90f4b740b447b1702193b08efc04ba4decbf26))
* prompt cleanup and new starter examples ([896a022](https://github.com/justinmerrell/podflow/commit/896a02297a68d350ce815d39a399a9e1fe7b8650))
* remote exec ([53ce856](https://github.com/justinmerrell/podflow/commit/53ce8566be506b4970b7c791bf6cca9e0fd98676))
* runpodctl project build to emit dockerfile ([7844b5d](https://github.com/justinmerrell/podflow/commit/7844b5d2d06aa538c4af0f809fd76ac89554fe76))
* updated readme and requirements ([b800f1f](https://github.com/justinmerrell/podflow/commit/b800f1f2a82532577819e83ecaca3ed1994700b4))


### Bug Fixes

* adapt deploy to venv path ([3e9d115](https://github.com/justinmerrell/podflow/commit/3e9d115ba027a1b9007759160cdbb333c970b3a9))
* add -qO- ([15892c2](https://github.com/justinmerrell/podflow/commit/15892c2f92299595216797b3d9b8c857ead1fdcc))
* added detail errors back ([0de3690](https://github.com/justinmerrell/podflow/commit/0de3690ca269f26d4a18ac43b4ee40409ea4f27b))
* backwards compatibility ([239d8fd](https://github.com/justinmerrell/podflow/commit/239d8fdf6b820494bfcf3a58739a5208beaeec11))
* brew action needs permissions ([70f4dce](https://github.com/justinmerrell/podflow/commit/70f4dce78851719ce89a0a7221e99d0dccb285bf))
* brew install ([01f0c89](https://github.com/justinmerrell/podflow/commit/01f0c89d824ffea179fdc1a0f924b09f6edc897b))
* cleanup install script ([c8a76d7](https://github.com/justinmerrell/podflow/commit/c8a76d78cdb193c267ce443158ab9d608857230c))
* complete renaming ([3da74ab](https://github.com/justinmerrell/podflow/commit/3da74aba882d06adbf49f59da4a2d92d8e327998))
* correct verbose for rsync, and dep fix ([8e4d10b](https://github.com/justinmerrell/podflow/commit/8e4d10bacf15f0bd069cc44890485024f9d65aa0))
* detect OS earlier ([d9fc83b](https://github.com/justinmerrell/podflow/commit/d9fc83bce91dec8d26e9e6eca319921df6acdb3d))
* enhance user clarity ([5ac4059](https://github.com/justinmerrell/podflow/commit/5ac4059d0f3560d80572defa9ab09e139b8977c9))
* expose better printing ([4767fe2](https://github.com/justinmerrell/podflow/commit/4767fe2ed1dfd3a2643c4fda4f5d0af92097dc23))
* fix: the feat: and feat: the fix: ([8f418f3](https://github.com/justinmerrell/podflow/commit/8f418f330f07a3ec42490fcf2275734a02d76065))
* forgot to make a change ([0335586](https://github.com/justinmerrell/podflow/commit/0335586b9c44818d58bcba00c1d2653d90649dca))
* hack to make runpodignore use gitignore syntax on the server ([9e1dd71](https://github.com/justinmerrell/podflow/commit/9e1dd71aba05a6ffddd43d74c6a582d5fa760448))
* ignore more rysnc and remove jq ([3309865](https://github.com/justinmerrell/podflow/commit/3309865d9176827157e270ea7f12bbf8e6fe1dbf))
* improve install script ([eeed522](https://github.com/justinmerrell/podflow/commit/eeed522c066998ab510460bef9f8cd8161d91de7))
* improved bash resiliency ([3e0eadb](https://github.com/justinmerrell/podflow/commit/3e0eadbf0d7594d3a4d18008297f76583b289dde))
* mislabeled in release ([9c850cb](https://github.com/justinmerrell/podflow/commit/9c850cbe508cf988dcfde277e8f279dbf246ad25))
* moved doc to docs ([73b6290](https://github.com/justinmerrell/podflow/commit/73b629087553180e3a3fb9d02200c2ed8f66df48))
* naming and prompting ([232f373](https://github.com/justinmerrell/podflow/commit/232f373d1d56e98f5c8cff6bedbcc8f42ff0b1e1))
* persistent typo ([02f38db](https://github.com/justinmerrell/podflow/commit/02f38dbc9e11d2f22028538f73f67c938738be61))
* quotes ([7c260aa](https://github.com/justinmerrell/podflow/commit/7c260aa178006cf51bc18d4d8ce0dbabd4f5138f))
* readme rename ([d8ed9c7](https://github.com/justinmerrell/podflow/commit/d8ed9c74621ee092b99900ab076fed11f58b0b92))
* reinstate release-please and do brew action after ([062e881](https://github.com/justinmerrell/podflow/commit/062e881c83e1c52b2e1498043c890bed715bef8d))
* remove projects ([20503b4](https://github.com/justinmerrell/podflow/commit/20503b444be336231f013bcf776304c02202eb10))
* removed unused relay list ([f5cde85](https://github.com/justinmerrell/podflow/commit/f5cde856269d71c7c0f14cc02e722a4c451a8503))
* rename new to create ([7a7aba0](https://github.com/justinmerrell/podflow/commit/7a7aba0df85fba0b40028e4c8b39f43be25ae9da))
* rename runpodctl to runpod ([223dd40](https://github.com/justinmerrell/podflow/commit/223dd40102dcf8a460049d04e90ff334471ca3c6))
* seems the new architectures aren't building in github action ([0cefd3c](https://github.com/justinmerrell/podflow/commit/0cefd3c380bbef42cb471f43b37dc224051b9140))
* stable diffusion name ([ea2a35a](https://github.com/justinmerrell/podflow/commit/ea2a35af5254f5630d948cdfc07da8779a83bf11))
* support --version flag ([4e7ae63](https://github.com/justinmerrell/podflow/commit/4e7ae630de784439003f8e45ea846f76431afc30))
* support non base images ([88a0776](https://github.com/justinmerrell/podflow/commit/88a0776e9b44ca5939f61aa62606469a11ac5e69))
* tab to spaces ([cdce259](https://github.com/justinmerrell/podflow/commit/cdce259e1baf8a9f57037ef18565de278bbd9694))
* trigger release-please ([5061c14](https://github.com/justinmerrell/podflow/commit/5061c1465b4675077a09cf0fe490b4178721ab6f))
* trigger release-please ([b82fd9c](https://github.com/justinmerrell/podflow/commit/b82fd9cc2dfa4821946a397d27db0c5f8c9c97fe))
* update dockerfile ([138bd15](https://github.com/justinmerrell/podflow/commit/138bd15551bd3d3ecb0ace33900f926b74f89603))
* update installer ([b87d34f](https://github.com/justinmerrell/podflow/commit/b87d34fc8ee90051d2911ab84adc10983c9ec17c))
* update root name ([270172d](https://github.com/justinmerrell/podflow/commit/270172d24f1083c88ccbedf3cd22c8bef4d4c32d))
* version check ([0536a8a](https://github.com/justinmerrell/podflow/commit/0536a8a4adb687ab927be64e695e1557985a6116))
* version check order ([066a07c](https://github.com/justinmerrell/podflow/commit/066a07c55c013a134d19c2b7f3d0962fbb37bb5d))
* windows antivirus doesn't let us do the right update logic ([85e7bbb](https://github.com/justinmerrell/podflow/commit/85e7bbb83b77b78b70d408444c42f8901036ba6d))
* windows compatibility and toml fix ([004a306](https://github.com/justinmerrell/podflow/commit/004a30610726f67641b412f1f209848bbb3e0f45))
